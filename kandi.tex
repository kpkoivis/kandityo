...
\abstract{Tutkielmassa perehdytään päätöspuiden perusteisiin, niiden muodostamisessa
käytettyihin induktioalgoritmeihin sekä kahteen esimerkkiin, joissa niitä on sovellettu
...
Päätöspuut ovat ennen kaikkea tehokkaita luokittimia. Niiden käyttäminen päätöksenteon
tuen apukeinona on mahdollista tilanteissa, joissa päätöksenteko on luonteeltaan juuri
luokitteluongelma: yhteen vaihtoehtoon päätymistä monien mahdollisten vaihtoehtojen joukosta.
Tällaisia tilanteita on terveydenhuollossa runsaasti -
jo lääketieteellisen diagnoosin tekeminen on usein juuri luokittelua, jossa
lääkäri pyrkii potilaan ominaisuuksien perusteella päätymään oikeaan diagnoosiin.
Soveltamismahdollisuuksia on kuitenkin
...
terveydenhuollon prosesseihin on hajanaista ja näyttö menetelmien hyödyllisyydestä on
olematonta tai ristiriitaista.
}
...
\centering
    ...
    \textbf{Nro} & \textbf{\text{Ulkonäkö}} & \textbf{Vamma- mekanismi} & \textbf{Kipu} & \textbf{Varaa- minen} & \textbf{Kuvataan} \\ \hline
...
Esitellään kaksi kirjallisuudessa kuvattua päätöspuiden sovellusta terveydenhuollon kontekstissa.
...
menetelmien hyödylliyydestä on joko olematonta tai ristiriitaista näyttöä. Menetelmistä näyttäisi
...
aivoverisuonisairauksien ennustamiseksi potilaiden ominaisuuksien perusteella. Parhaimmaksi
osoittautui päätöspuihin perustuva luokitin. Tutkimuksessa käytettiin
...
päädyttiin 493 potilaan tiedoista koostuvassa aineistossa päätöspuuhun, jossa 29 attribuutin joukosta
